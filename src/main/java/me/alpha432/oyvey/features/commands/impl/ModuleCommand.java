...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : CrackedClient.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : CrackedClient.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = CrackedClient.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = CrackedClient.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
