...
public final class AutoTotem extends Module {
            ...
            if (slot >= 9) {
                switch (mode.getValue()) {
                    ...
                    case MatrixPick -> {
                        ...
                        CrackedClient.asyncManager.run(() -> mc.player.getInventory().selectedSlot = prevSlot, 300);
                    }
                    case NewVersion -> {
                        debug(slot + " swap");
    ...
    public int getItemSlot() {
        ...
        if (onCrystalInHand.getValue()) {
            for (PlayerEntity pl : mc.world.getPlayers()/*PlayerEntity pl : OyVey.asyncManager.getAsyncPlayers()*/) {
