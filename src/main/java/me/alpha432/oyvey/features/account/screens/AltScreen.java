...
import me.alpha432.oyvey.features.account.altmanager.Alt;
...
public class AltScreen extends Screen {
	...
	public List<Alt> getAltList() {
		return CrackedClient.altManager.getAlts();
	}
	...
	public void loginToSelected() {
		...
		if (alt.isCracked()) {
			CrackedClient.altManager.loginCracked(alt.getEmail());
		} else {
			CrackedClient.altManager.login(alt);
		}
	}
	...
	public void deleteSelected() {
		...
		CrackedClient.altManager.removeAlt(alt);
		this.refreshAltList();
	}
}
