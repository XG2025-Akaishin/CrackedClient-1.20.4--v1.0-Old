package me.alpha432.oyvey.features.account.altmanager;
...
import me.alpha432.oyvey.mixin.altmixin.interfaces.IMinecraftClient;
...
public class AltManager {
	 ...
	 */
	public AltManager(MinecraftClient mc) {
		this.mc = mc;
		//mc = OyVey.MC;
		readAlts();
	}
	...
	public void readAlts() {
		try {
			...
			File altFile = new File(mc.runDirectory, "Cracked_Alts.json");
			if (!altFile.exists())
	...
	public void saveAlts() {
		...
		try {
			// Finds the file and opens it.
			File altFile = new File(mc.runDirectory, "Cracked_Alts.json");
			System.out.println("[Cracked] Saving Alts");
			...
			System.out.println("[Cracked] Failed to save alts");
		}
		printwriter.close();
	}
